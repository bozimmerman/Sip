...
// Add your handling code here:
  ...
  private void button1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button1MouseClicked
        ...
        {
            ((Sip)myParent).C.disconnect();
			((Sip)myParent).C=new Connector();
            String success=((Sip)myParent).C.connect(myParent,theList[list2.getSelectedIndex()],thePorts[list2.getSelectedIndex()]);
            if(success.length()==0)
            {
                closeDialog(null);
                ((Sip)myParent).C.start();
...
// Add your handling code here:
  ...
  private void button4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buttonKeyPressed
        if((evt.getKeyCode()==10)||(evt.getKeyCode()==13))
  ...
  private void button4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button3MouseClicked
        if((list2.getSelectedIndex()>0)&&(list2.getSelectedIndex()<listIndex)&&(listIndex>0))
        {
            for(int i=list2.getSelectedIndex();i<listIndex;i++)
            {
      ...
      if(textField2.getText().length()>0)
      {
          try
          {
              ...
              if(ok)
              {
                  ...
                  list2.add((theList[listIndex].trim()+"                       ").substring(0,30)+" "+thePorts[listIndex]);
                  listIndex++;
				  myParent.save(theList,thePorts,listIndex,myParent.hotkeys);
              }
              textField1.setText("");
							...
							else
							{
								...
								if(porter!=null)
								{
								    try
								    {
								        ...
								        list2.add((line.trim()+"                       ").substring(0,30)+" "+thePorts[listIndex]);
